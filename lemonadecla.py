...
price_per_cup = float(input("Enter the price per lemonade cup is USD- "))
cups_sold = int(input("Enter the amount cups sold- "))
...
print("Total Cosr:", rounded_total)
...
def thank_you_message(cups):
    if cups >=5:
        return "Thank you for supporting my bussiness."
    else:
