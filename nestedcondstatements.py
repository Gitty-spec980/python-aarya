# # Write a program to check whether the student can take an exam or not. Students will be allowed only in two conditions: If they have a medical cause (‘Y’ for yes and ‘N’ for no). IF yes, then they will be allowed. If NO (else), then check attendance If attendance is above 75, then allowed; otherwise, not allowed.

# Medicalcause= input("Enter if you have a medical cause- ")

# if Medicalcause=="Yes":
#     print("You are allowed to take the Test. Good Luck")
# else:
#     print("Do you have an attendance higher than 75?")

#     attendance= int(input("Enter your attendance grade here- "))

#     if attendance>75:
#         print("You are allowed to take the test")
#     else:
#         print("You are not allowed to take a test. You are a dissapointment.")
...
units=int(input("Enter the amount of units you ate- "))
